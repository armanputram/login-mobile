    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Bibliografi Kategori</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('bibliografikat.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="deskripsi" class="form-control" placeholder="Mohon diisi deskripsi">
                            </div>
                        </div>
